...
public class ConfigPath {
    ...
    public static final String GENERATOR_DIAMOND_TIER_IV_DELAY = "diamond.tierIV.delay";
    public static final String GENERATOR_DIAMOND_TIER_IV_AMOUNT = "diamond.tierIV.amount";
    public static final String GENERATOR_DIAMOND_TIER_IV_SPAWN_LIMIT = "diamond.tierIV.spawn-limit";
    public static final String GENERATOR_DIAMOND_TIER_IV_START = "diamond.tierIV.start";

    public static final String GENERATOR_DIAMOND_TIER_V_DELAY = "diamond.tierV.delay";
    public static final String GENERATOR_DIAMOND_TIER_V_AMOUNT = "diamond.tierV.amount";
    public static final String GENERATOR_DIAMOND_TIER_V_SPAWN_LIMIT = "diamond.tierV.spawn-limit";
    public static final String GENERATOR_DIAMOND_TIER_V_START = "diamond.tierV.start";
    ...
    public static final String GENERATOR_EMERALD_TIER_IV_DELAY = "emerald.tierIV.delay";
    public static final String GENERATOR_EMERALD_TIER_IV_AMOUNT = "emerald.tierIV.amount";
    public static final String GENERATOR_EMERALD_TIER_IV_SPAWN_LIMIT = "emerald.tierIV.spawn-limit";
    public static final String GENERATOR_EMERALD_TIER_IV_START = "emerald.tierIV.start";

    public static final String GENERATOR_EMERALD_TIER_V_DELAY = "emerald.tierV.delay";
    public static final String GENERATOR_EMERALD_TIER_V_AMOUNT = "emerald.tierV.amount";
    public static final String GENERATOR_EMERALD_TIER_V_SPAWN_LIMIT = "emerald.tierV.spawn-limit";
    public static final String GENERATOR_EMERALD_TIER_V_START = "emerald.tierV.start";
    ...
    // 直击击退
    private static final String GENERAL_FIREBALL_DIRECT_HIT_PATH = GENERAL_FIREBALL_PATH + ".direct-hit";
    public static final String GENERAL_FIREBALL_DIRECT_HIT_VERTICAL = GENERAL_FIREBALL_DIRECT_HIT_PATH + ".vertical";
    public static final String GENERAL_FIREBALL_DIRECT_HIT_HORIZONTAL = GENERAL_FIREBALL_DIRECT_HIT_PATH + ".horizontal";
    ...
    public static final String GENERAL_FIREBALL_DAMAGE_SPLASH_ENEMY = GENERAL_FIREBALL_DAMAGE_PATH + ".splash-enemy";
