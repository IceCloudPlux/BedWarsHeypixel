...
public class Messages {
    ...
    public static String ARENA_STATUS_START_PLAYER_SUBTITLE = "arena-start-subtitle";
    ...
    public static String FORMATTING_GENERATOR_TIER4 = "format-tier4";
    public static String FORMATTING_GENERATOR_TIER5 = "format-tier5";
