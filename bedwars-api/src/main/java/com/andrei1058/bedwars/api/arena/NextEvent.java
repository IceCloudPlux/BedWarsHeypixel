...
public enum NextEvent {
    ...
    DIAMOND_GENERATOR_TIER_IV("next-event.diamond-IV"),
    DIAMOND_GENERATOR_TIER_V("next-event.diamond-V"),
    EMERALD_GENERATOR_TIER_II("next-event.emerald-II"),
    EMERALD_GENERATOR_TIER_III("next-event.emerald-III"),
    EMERALD_GENERATOR_TIER_IV("next-event.emerald-IV"),
    EMERALD_GENERATOR_TIER_V("next-event.emerald-V"),
