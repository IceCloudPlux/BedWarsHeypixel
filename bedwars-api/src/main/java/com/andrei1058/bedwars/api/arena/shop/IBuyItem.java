...
public interface IBuyItem {
    ...
    /**
     * Give content to a player with stack option
     * @param buyStack if true, give a full stack (64 for normal items, 16 for ender pearls, 1 for non-stackable)
     */
    void give(Player player, IArena arena, boolean buyStack);
