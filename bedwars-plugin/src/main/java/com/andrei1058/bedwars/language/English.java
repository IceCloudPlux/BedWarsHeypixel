...
public class English extends Language {
    ...
    public English() {
        ...
        yml.addDefault(Messages.ARENA_STATUS_START_PLAYER_SUBTITLE, "&eProtect your bed and destroy the enemy beds!");
        ...
        // XP Mode Shop New Items Names
        yml.addDefault("shop-items-netherite-armor-name", "&6Netherite Armor Set");
        yml.addDefault("shop-items-golden-sword-ex-name", "&6Excalibur EX");
        yml.addDefault("shop-items-netherite-sword-name", "&6Netherite Sword");
