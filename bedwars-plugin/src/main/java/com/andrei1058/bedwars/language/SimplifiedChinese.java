...
public class SimplifiedChinese extends Language {
    ...
    public SimplifiedChinese() {
        ...
        // 添加10-6秒的倒计时title配置
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE + "-10", "&e❿");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE + "-9", "&e❾");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE + "-8", "&e❽");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE + "-7", "&e❻");
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_SUB_TITLE + "-6", "&e❹");
        // 保留原有的5-1秒配置
        ...
        yml.addDefault(Messages.ARENA_STATUS_START_PLAYER_SUBTITLE, "&e保护你的床并摧毁敌人的床！");
        ...
        yml.addDefault(Messages.FORMATTING_GENERATOR_TIER4, "IV");
        yml.addDefault(Messages.FORMATTING_GENERATOR_TIER5, "V");
        ...
        yml.addDefault(Messages.FORMATTING_SB_TAB_PLAYING_PREFIX, List.of("{teamColor}{teamName} &f| "));
        yml.addDefault(Messages.FORMATTING_SB_TAB_PLAYING_SUFFIX, List.of("{teamColor}"));
        ...
        // 经验模式商店新物品名称
        yml.addDefault("shop-items-netherite-armor-name", "&6下界合金套装");
        yml.addDefault("shop-items-golden-sword-ex-name", "&6石中剑 EX");
        yml.addDefault("shop-items-netherite-sword-name", "&6下界合金剑");
        ...
        addContentMessages(yml, "jump-potion", ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "{color}跳跃提升 IV 药水（30 秒）", Arrays.asList("&7花费：{cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        ...
        addContentMessages(yml, "rescue-platform", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}救援平台", Arrays.asList("&7花费：{cost} {currency}", "",
                "&7右键使用，在你脚下生成一个粘液平台", "&7保护你免于掉落", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "return-scroll", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}回城卷轴", Arrays.asList("&7花费：{cost} {currency}", "",
                "&7右键使用，5秒后传送回队伍出生点", "&7移动会取消传送", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "defense-wall", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}防御墙", Arrays.asList("&7花费：{cost} {currency}", "",
                "&7放置后在前方生成3x5的砖块墙壁", "&7保护你免受敌人攻击", "", "{quick_buy}", "{buy_status}"));
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_LORE.replace("{name}", "swords"),
                Arrays.asList("&7队伍的所有剑和斧获得锋利附魔！", "", "{tier_1_color}等级 1：锋利 I，&b{tier_1_cost} {tier_1_currency}",
                        "{tier_2_color}等级 2：锋利 II，&b{tier_2_cost} {tier_2_currency}",
                        "{tier_3_color}等级 3：锋利 III，&b{tier_3_cost} {tier_3_currency}",
                        "{tier_4_color}等级 4：锋利 IV，&b{tier_4_cost} {tier_4_currency}", ""));
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "swords").replace("{tier}", "tier-2"), "{color}锋利附魔 II");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "swords").replace("{tier}", "tier-3"), "{color}锋利附魔 III");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "swords").replace("{tier}", "tier-4"), "{color}锋利附魔 IV");
        ...
        // Respawn Time Reduction - 重生时间减少
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "respawn"), "{color}重生时间减少");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_LORE.replace("{name}", "respawn"),
                Arrays.asList("&7减少队伍玩家的重生时间！", "",
                        "{tier_1_color}等级 1：减少 0.5 秒，&b{tier_1_cost} {tier_1_currency}",
                        "{tier_2_color}等级 2：减少 1.0 秒，&b{tier_2_cost} {tier_2_currency}",
                        "{tier_3_color}等级 3：减少 1.5 秒，&b{tier_3_cost} {tier_3_currency}",
                        "{tier_4_color}等级 4：减少 2.0 秒，&b{tier_4_cost} {tier_4_currency}", ""));
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "respawn").replace("{tier}", "tier-2"), "{color}重生时间减少 II");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "respawn").replace("{tier}", "tier-3"), "{color}重生时间减少 III");
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "respawn").replace("{tier}", "tier-4"), "{color}重生时间减少 IV");
