...
public class UpgradesConfig extends ConfigManager {
    ...
    public UpgradesConfig(String name, String dir) {
        ...
        List<String> elements = Arrays.asList("upgrade-swords,10", "upgrade-armor,11", "upgrade-miner,12", "upgrade-forge,13",
                "upgrade-heal-pool,14", "upgrade-respawn,15", "category-traps,16", "separator-glass,18,19,20,21,22,23,24,25,26",
        ...
        // Determine cost values based on config file name
        boolean isUpgrades3 = name.equals("upgrades3");
        int[] swordCosts = isUpgrades3 ? new int[]{8, 12, 32, 50} : new int[]{4, 8, 12, 32};
        int[] armorCosts = isUpgrades3 ? new int[]{5, 10, 20, 30} : new int[]{2, 4, 8, 16};

        if (isFirstTime()) {
            yml.addDefault("upgrade-swords.tier-1.cost", swordCosts[0]);
            ...
            yml.addDefault("upgrade-swords.tier-2.cost", swordCosts[1]);
            yml.addDefault("upgrade-swords.tier-2.currency", "diamond");
            addDefaultDisplayItem("upgrade-swords.tier-2", "IRON_SWORD", 0, 2, false);
            yml.addDefault("upgrade-swords.tier-2.receive", Arrays.asList("enchant-item: DAMAGE_ALL,2,sword"));

            yml.addDefault("upgrade-swords.tier-3.cost", swordCosts[2]);
            yml.addDefault("upgrade-swords.tier-3.currency", "diamond");
            addDefaultDisplayItem("upgrade-swords.tier-3", "IRON_SWORD", 0, 3, false);
            yml.addDefault("upgrade-swords.tier-3.receive", Arrays.asList("enchant-item: DAMAGE_ALL,3,sword"));

            yml.addDefault("upgrade-swords.tier-4.cost", swordCosts[3]);
            yml.addDefault("upgrade-swords.tier-4.currency", "diamond");
            addDefaultDisplayItem("upgrade-swords.tier-4", "IRON_SWORD", 0, 4, false);
            yml.addDefault("upgrade-swords.tier-4.receive", Arrays.asList("enchant-item: DAMAGE_ALL,4,sword"));

            yml.addDefault("upgrade-armor.tier-1.currency", "diamond");
            yml.addDefault("upgrade-armor.tier-1.cost", armorCosts[0]);
            ...
            yml.addDefault("upgrade-armor.tier-2.cost", armorCosts[1]);
            ...
            yml.addDefault("upgrade-armor.tier-3.cost", armorCosts[2]);
            ...
            yml.addDefault("upgrade-armor.tier-4.cost", armorCosts[3]);
            ...
            // Respawn time reduction upgrade (4 tiers, each reducing 0.5 seconds)
            yml.addDefault("upgrade-respawn.tier-1.currency", "diamond");
            yml.addDefault("upgrade-respawn.tier-1.cost", 5);
            addDefaultDisplayItem("upgrade-respawn.tier-1", "CLOCK", 0, 1, false);
            yml.addDefault("upgrade-respawn.tier-1.receive", Collections.singletonList("respawn-reduction: 0.5"));

            yml.addDefault("upgrade-respawn.tier-2.currency", "diamond");
            yml.addDefault("upgrade-respawn.tier-2.cost", 8);
            addDefaultDisplayItem("upgrade-respawn.tier-2", "CLOCK", 0, 2, false);
            yml.addDefault("upgrade-respawn.tier-2.receive", Collections.singletonList("respawn-reduction: 1.0"));

            yml.addDefault("upgrade-respawn.tier-3.currency", "diamond");
            yml.addDefault("upgrade-respawn.tier-3.cost", 12);
            addDefaultDisplayItem("upgrade-respawn.tier-3", "CLOCK", 0, 3, false);
            yml.addDefault("upgrade-respawn.tier-3.receive", Collections.singletonList("respawn-reduction: 1.5"));

            yml.addDefault("upgrade-respawn.tier-4.currency", "diamond");
            yml.addDefault("upgrade-respawn.tier-4.cost", 16);
            addDefaultDisplayItem("upgrade-respawn.tier-4", "CLOCK", 0, 4, false);
            yml.addDefault("upgrade-respawn.tier-4.receive", Collections.singletonList("respawn-reduction: 2.0"));
