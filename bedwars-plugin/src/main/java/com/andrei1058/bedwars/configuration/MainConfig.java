...
public class MainConfig extends ConfigManager {
    ...
    public MainConfig(Plugin plugin, String name) {
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_BEDS_DESTROY_COUNTDOWN, 2700);  // 45 minutes (game ends at 60 min, 15 min gap)
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_DRAGON_SPAWN_COUNTDOWN, 2700);  // Same time as beds destroy (sudden death removed)
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_GAME_END_COUNTDOWN, 900);  // 15 minutes after beds destroy (total 60 min)
        ...
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_SPEED_MULTIPLIER, 1.0);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_MAKE_FIRE, false);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_KNOCKBACK_HORIZONTAL, 1.2);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_KNOCKBACK_VERTICAL, 0.7);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_DIRECT_HIT_HORIZONTAL, 0.4);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_DIRECT_HIT_VERTICAL, 0.2);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_COOLDOWN, 0.1);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_DAMAGE_SELF, 1.0);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_DAMAGE_ENEMY, 6.0);
        yml.addDefault(ConfigPath.GENERAL_FIREBALL_DAMAGE_SPLASH_ENEMY, 2.0);
