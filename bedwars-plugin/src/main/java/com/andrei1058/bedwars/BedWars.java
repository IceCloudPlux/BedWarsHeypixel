/*
 * BedWarsHeypixel - A bed wars mini-game.
 * Based on BedWars1058 by Andrei Dascălu (andrei1058)
 * Copyright (C) 2021 Andrei Dascălu
 * Secondary development by heypixel
 *
 ...
 *
 * Original project: https://github.com/andrei1058/BedWars1058
...
import com.andrei1058.bedwars.listeners.custom.*;
import com.andrei1058.bedwars.listeners.XpModePickupListener;
...
import com.andrei1058.bedwars.utils.LicenseChecker;
...
public class BedWars extends JavaPlugin {
    ...
    public static String mainCmd = "bw", link = "https://minebbs.com/resources/50942/";
    ...
    public void onEnable() {
        ...
        registerEvents(
                ...
                new FireballListener(), new SpectatorListeners(), new BaseListener(),
                new TargetListener(), new LangListener(), new Warnings(this), new ChatAFK(),
                new GameEndListener(), new DefaultStatsHandler(),
                // Custom listeners for BuJiDao gameplay
                new BlazeProjectileListener(), new BridgeEggListener(),
                new SilverfishSnowballListener(), new DualWieldComboListener(),
                new RescuePlatformListener(), new ReturnScrollListener(),
                new DefenseWallListener(),
                new XpModePickupListener()
        );
        ...
        /* Initialize XP Mode configuration */
        new XpModeConfig(this);
        ...
        String licenseKey = config.getYml().getString("license-key");
        if (licenseKey == null || licenseKey.trim().isEmpty()) {
            getLogger().severe("No license key configured! Set 'license-key' in config.yml and restart the server.");
        ...
        getLogger().info("Verifying license key...");
        Bukkit.getScheduler().runTaskAsynchronously(this, () -> {
            boolean valid = LicenseChecker.verify(trimmedKey);
            Bukkit.getScheduler().runTask(this, () -> {
                if (valid) {
                    getLogger().info("License verification passed! Plugin is fully enabled.");
                } else {
                    getLogger().severe("License verification FAILED! The provided license key is invalid.");
                    getLogger().severe("Disabling plugin...");
                    Bukkit.getPluginManager().disablePlugin(this);
                }
            });
